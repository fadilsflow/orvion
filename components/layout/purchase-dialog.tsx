  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle className="flex items-center text-center  flex-col">
            {product.name}
          </DialogTitle>
          <DialogDescription className="flex items-center text-center  flex-col">
            Pilih cara Anda ingin melanjutkan pembelian
          </DialogDescription>
        </DialogHeader>
        ...
        <Tabs defaultValue="details" className="w-full">
          ...
          <TabsContent value="purchase">
            <div className="space-y-4 mt-4">
              <Button
                variant="outline"
                className="w-full gap-2 bg-emerald-800 hover:bg-emerald-900 border-emerald-500 text-white"
              ...
              <Alert variant="default">
                ...
                <AlertDescription>
                  Pembelian melalui platform sedang dalam perbaikan. Silakan
                  gunakan WhatsApp untuk saat ini.
                </AlertDescription>
              </Alert>
            </div>
          </TabsContent>
